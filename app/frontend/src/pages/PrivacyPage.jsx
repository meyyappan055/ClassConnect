    ...
    <div className="max-w-3xl mx-auto p-6 space-y-6 font-inter">
      ...
      <Card className="p-6 shadow-md">
        <ScrollArea className="h-[60vh] overflow-y-auto p-4 space-y-6 ">
          <section>
            <h2 className="text-xl font-semibold pb-4">1. Service Overview</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold py-4">2. User Responsibility</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold py-4">3. Data Handling</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold py-4">4. Limitation of Liability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold py-4">5. Updates to ToS</h2>
            <p>
